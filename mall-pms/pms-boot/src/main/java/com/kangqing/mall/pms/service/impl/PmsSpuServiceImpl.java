...
import com.kangqing.mall.pms.pojo.domain.*;
import com.kangqing.mall.pms.pojo.dto.SpuDTO;
import com.kangqing.mall.pms.service.*;
...
public class PmsSpuServiceImpl extends ServiceImpl<PmsSpuMapper, PmsSpu> implements IPmsSpuService {
    ...
    private final IPmsSpuSpecValueService iPmsSpuSpecValueService;
    ...
    @Override
    public boolean updateById(ProductBO productBO) {
        SpuDTO SpuDTO = productBO.getSpu();
    ...
    @Override
    public com.kangqing.mall.pms.pojo.bo.app.ProductBO getProductByIdForApp(Long spuId) {
        // spu
        ...
        com.kangqing.mall.pms.pojo.bo.app.ProductBO product = new com.kangqing.mall.pms.pojo.bo.app.ProductBO(SpuDTO, attrs, specs, skuList);
        return product;
    }
}
