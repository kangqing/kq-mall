package com.kangqing.common.web.util;
...
public class IPUtils {
    ...
    public static String getIpAddr(HttpServletRequest request) {
        ...
        //使用代理，则获取第一个IP地址
        if (StrUtil.isNotBlank(ip) && (ip != null ? ip.indexOf(",") : 0) > 0) {
    ...
    public static String getCityInfo(String ip, Integer algorithm) {
        ...
        if (!file.exists()) {
            ...
            if (!file.exists()) {
                try {
                    FileUtils.copyInputStreamToFile(Objects.requireNonNull(IPUtils.class.getClassLoader()
