package com.kangqing.common.web.aspect;

import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.kangqing.common.constant.AuthConstants;
import com.kangqing.common.web.util.IPUtils;
...
public class LoginLogAspect {
    ...
    // TODO yx
    @Pointcut("execution(public * com.kangqing.auth.controller.AuthController.postAccessToken(..))")
    public void Log() {
    }
