package com.kangqing.mallmbpg.config;
...
public class CodeGeneratorConfig {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/mall-mbpg/src/main/java"); //生成文件的输出目录
        ...
        pc.setParent("com.kangqing.mallmbpg");//父包名。// 自定义包路径  如果为空，将下面子包名必须写全部， 否则就只需写子包名
        pc.setEntity("pojo");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/mall-mbpg/src/main/resources/mapper/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
